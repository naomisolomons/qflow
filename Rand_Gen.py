...
def generator(): #This function generates random levels for Qflow based on user input 
    ...
    num_qubit = int(input('Enter the number of Qubits:'))# take user input for number of qubits and depth.
    depth = int(input('Enter the circuit depth:'))# recomend 2 qubits for now. 
